...
追う分野。論点は「どう縮めるか(手法)」→「何で教えるか(データ)」→「一様適用の解体」と降りてきたが、
**2026-W33 で前提そのものが2つ崩れた**。(1) **蒸留の効果は「容量差」ではなく「情報差」から来ているかもしれない** ——
teacher/student が同一サイズで、非対称なのは **teacher だけが何かを見ていること**だけ、という構成が1週間で5本。
(2) **適合はだいたい成功している。壊れているのは選択のほうだ** —— 8万モデルの統制実験が、
**良いモデルは存在するのにラベル無しでは選び出せない**ことを示した。
実務指針も更新される: **新しい適合アルゴリズムを作るより、選択の手続きを直すほうが安く効く。**
そして蒸留の壊れ方は今週で**5つの独立した顔**まで地図が埋まった(伝わらない / 上書きする / 発散と欠損 / teacher 不要 / teacher が捨てたものが伝わらない)。
